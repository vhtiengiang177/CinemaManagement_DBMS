...
namespace CinemaManagement.GUI
{
    public partial class fAddShowtimes : Form
    {
        ...
        private void btnCheckShift_Click(object sender, EventArgs e)
        {
            ...
            if (ShowtimesDAO.Instance.countShiftInDay(cboShift.ValueMember.ToString()).Rows.Count > 0)
            {
                int count = Convert.ToInt32(ShowtimesDAO.Instance.countShiftInDay(cboShift.ValueMember.ToString()).Rows[0][0].ToString());
